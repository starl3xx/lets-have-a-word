...
- **Word Lists**
  - Import unified WORDS list from `guess_words_clean.ts` (4,438 curated words)
...
The word wheel displays all 4,438 possible guess words, and each user sees a different starting position to provide variety and prevent pattern recognition.
