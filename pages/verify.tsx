          ...
          <div className="mt-6 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-4 py-4">
              ...
              <div className="mb-4">
                ...
                <ExternalLink
                  href={`https://basescan.org/address/${JACKPOT_CONTRACT_ADDRESS}`}
              ...
              <div>
                ...
                <ExternalLink
                  href={`https://basescan.org/address/${WORD_MANAGER_ADDRESS}`}
    ...
    <div className={`rounded-xl px-4 py-3 ${hashesMatch ? 'bg-green-50' : 'bg-red-50'}`}>
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          {startTxHash && (
            <ExternalLink
              href={`https://basescan.org/tx/${startTxHash}`}
  ...
  return (
    <div className="bg-purple-50 rounded-xl px-4 py-3">
      <div className="min-w-0 flex-1">
        ...
        {roundCommitTxHash && (
          <ExternalLink
            href={`https://basescan.org/tx/${roundCommitTxHash}`}
            className="inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-700 mt-2 font-medium"
          >
        ...
        {wordManagerAddress && (
          <ExternalLink
            href={`https://basescan.org/address/${wordManagerAddress}`}
