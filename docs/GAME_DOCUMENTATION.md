...
│   ├── data/
│   │   ├── guess_words_clean.ts     # 4,584 unified word list (UPPERCASE)
...
- **Alphabetical Display**: All 4,584 words sorted A-Z
...
- **Wheel**: Displays all 4,584 words using virtualization
